...
let IngredientRepository = class IngredientRepository extends base_supabase_repository_1.BaseSupabaseRepository {
    constructor(supabase) {
        super(supabase, 'ingredients', ingredient_model_1.Ingredient);
    }
    async findByName(name) {
        ...
        return data ? ingredient_model_1.Ingredient.fromJSON(data) : null;
    }
};
exports.IngredientRepository = IngredientRepository;
exports.IngredientRepository = IngredientRepository = __decorate([
