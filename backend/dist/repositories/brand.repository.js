...
let BrandRepository = class BrandRepository extends base_supabase_repository_1.BaseSupabaseRepository {
    constructor(supabase) {
        super(supabase, 'brands', brand_model_1.Brand);
    }
    async findByName(name) {
        ...
        return data ? brand_model_1.Brand.fromJSON(data) : null;
    }
